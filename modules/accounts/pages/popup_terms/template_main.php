...
// +-----------------------------------------------------------------+
//  Path: /modules/accounts/pages/popup_terms/template_main.php
//
...
?>
<script type="text/javascript">dateReference.writeControl(); dateReference.dateFormat="<?php echo DATE_FORMAT_SPIFFYCAL; ?>";</script>
<?php 
