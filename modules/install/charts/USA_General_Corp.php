...
// +-----------------------------------------------------------------+
//  Path: /modules/install/charts/USA_General_Corp.php
//

// Chart of Accounts for USA simple General company
$chart_description = "US - General store simple Chart of Accounts (Corporations, S Corporations)";
$chart_array = array();
...
$chart_array[] = array('2680','Loans from Shareholders','24');
$chart_array[] = array('3300','Share Capital','24');
$chart_array[] = array("3400","Common Stock","40");
$chart_array[] = array("3500","Paid In Capital","40");
$chart_array[] = array("3600","Dividends Paid","42");
