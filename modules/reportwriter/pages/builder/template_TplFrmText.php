...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/pages/builder/template_TplFrmText.php
//

  $kFontColors = gen_build_pull_down($FontColors);
  echo html_form('FrmText', FILENAME_DEFAULT, gen_get_all_get_params(array('action')) . 'action=step6a');
...
<h2 align="center"><?php echo TEXT_FORM_FIELD . $DisplayName . ' - ' . TEXT_PROPERTIES; ?></h2>
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    <tr>
      <th colspan="2"><?php echo RW_RPT_TEXTDISP; ?></th>
    </tr>
    <tr>
      <td colspan="2" align="center">
	    <?php echo html_textarea_field('TextField', '50', '3', $Params['TextField']); ?>
      </td>
    </tr>
    <tr>
