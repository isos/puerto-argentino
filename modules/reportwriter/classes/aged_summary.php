...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/classes/aged_summary.php
//
...
if (file_exists(DIR_FS_WORKING . 'language/' . $_SESSION['language'] . '/classes/aged_summary.php')) {
  require(DIR_FS_WORKING . 'language/' . $_SESSION['language'] . '/classes/aged_summary.php');
} else {
  require(DIR_FS_WORKING . 'language/en_us/classes/aged_summary.php');
}
