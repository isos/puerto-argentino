...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/classes/income_statement.php
//
...
if (file_exists(DIR_FS_WORKING . 'language/' . $_SESSION['language'] . '/classes/income_statement.php')) {
  require(DIR_FS_WORKING . 'language/' . $_SESSION['language'] . '/classes/income_statement.php');
} else {
  require(DIR_FS_WORKING . 'language/en_us/classes/income_statement.php');
}
