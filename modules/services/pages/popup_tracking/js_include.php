...
var ship_cal = new ctlSpiffyCalendarBox("ship_cal", "popup_tracking", "ship_date", "btnDate2", "<?php echo gen_spiffycal_db_date_short($cInfo->ship_date); ?>", scBTNMODE_CALBTN);
var cal = new ctlSpiffyCalendarBox("cal", "popup_tracking", "deliver_date", "btnDate2", "<?php echo gen_spiffycal_db_date_short($cInfo->deliver_date); ?>", scBTNMODE_CALBTN);
