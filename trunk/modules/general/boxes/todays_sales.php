...
// +-----------------------------------------------------------------+
//  Path: /modules/general/boxes/todays_sales.php
//

class todays_sales extends ctl_panel {
  function todays_sales() {
	$this->module_id   = 'todays_sales';
	$this->category    = 'customers';
	$this->title       = CP_TODAYS_SALES_TITLE;
	$this->security    = SECURITY_ID_SALES_INVOICE;
	$this->description = CP_TODAYS_SALES_DESCRIPTION;
  }
