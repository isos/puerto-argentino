...
// +-----------------------------------------------------------------+
//  Path: /modules/general/boxes/my_notes.php
//

class my_notes extends ctl_panel {

  function my_notes() {
	$this->module_id   = 'my_notes';
	$this->category    = 'misc';
	$this->title       = CP_MY_NOTES_TITLE;
	$this->security    = 0; // unrestricted access to install
	$this->description = CP_MY_NOTES_DESCRIPTION;
  }
  ...
  function Update() {
	...
	$my_note   = db_prepare_input($_POST['my_note']);
