...
// +-----------------------------------------------------------------+
//  Path: /modules/general/boxes/personal_links.php
//

class personal_links extends ctl_panel {

	function personal_links() {
		$this->module_id   = 'personal_links';
		$this->category    = 'misc';
		$this->title       = CP_PERSONAL_LINKS_TITLE;
		$this->security    = 0; // unrestricted access
		$this->description = CP_PERSONAL_LINKS_DESCRIPTION;
	}
	...
	function Output($params) {
		...
		$control .= TEXT_TITLE . '&nbsp;' . html_input_field('my_title') . '<br />';
		$control .= TEXT_URL   . '&nbsp;' . html_input_field('my_url', '', 'size="50"');
		$control .= '&nbsp;&nbsp;&nbsp;&nbsp;';
		$control .= html_submit_field('my_personal_links', TEXT_ADD);
