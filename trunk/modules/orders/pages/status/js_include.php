...
// +-----------------------------------------------------------------+
//  Path: /modules/orders/pages/status/js_include.php
//
...
function deliveryList(oID) {
  window.open("index.php?cat=orders&module=popup_delivery&jID="+journal_ID+"&oID="+oID,"inv_delivery","width=700,height=550,resizable=1,scrollbars=1,top=150,left=200");
}
