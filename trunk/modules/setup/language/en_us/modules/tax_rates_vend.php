...
// +-----------------------------------------------------------------+
//  Path: /modules/setup/language/en_us/modules/tax_rates_vend.php
//
...
define('SETUP_HEADING_DELETE_TAX_RATE', 'Delete Tax Rate');
define('SETUP_DISPLAY_NUMBER_OF_TAX_RATES', TEXT_DISPLAY_NUMBER . 'tax rates');
define('SETUP_TAX_RATE_SUCCESS','Successfully added/updated the sales tax rate.');
