...
// +-----------------------------------------------------------------+
//  Path: /modules/services/pages/popup_shipping/template_main.php
//
...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
  <tr>
	...
	<td class="dataTableContent"><?php echo SHIPPING_TEXT_SHIPMENT_DATE; ?>
	  <script type="text/javascript">dateShipped.writeControl(); dateShipped.dateFormat="<?php echo DATE_FORMAT_SPIFFYCAL; ?>";</script>
	</td>
  </tr>
  <tr>
...
foreach ($module_list as $value) {
	...
	echo html_checkbox_field('ship_method_' . $value['id'], '1', $value['checked']) . ' ' . $value['text'];
	echo '</td></tr>' . chr(10);
}
?>
</table>
