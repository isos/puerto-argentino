...
// +-----------------------------------------------------------------+
//  Path: /my_files/custom/services/payment/language/en_us/modules/firstdata.php
//

// Admin Configuration Items
  define('MODULE_PAYMENT_FIRSTDATA_TEXT_TITLE', 'FirstData Global Gateway'); // Payment option title as displayed in the admin
  define('MODULE_PAYMENT_FIRSTDATA_TEXT_DESCRIPTION', 'When in test mode, cards return an Approved code but are not processed.<br /><br />');
