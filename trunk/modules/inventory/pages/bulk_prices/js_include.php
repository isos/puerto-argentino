...
function priceMgr(rowID, itemID) {
	...
	window.open('index.php?cat=inventory&module=popup_price_mgr&iID='+itemID+'&cost='+rowCost+'&price='+rowPrice,"price_mgr","width=800,height=400,resizable=1,scrollbars=1,top=150,left=200");
}
