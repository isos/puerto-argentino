...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/classes/subaccount_is.php
//
...
if (file_exists(DIR_FS_WORKING . 'language/' . $_SESSION['language'] . '/classes/subaccount_is.php')) {
  require(DIR_FS_WORKING . 'language/' . $_SESSION['language'] . '/classes/subaccount_is.php');
} else {
  require(DIR_FS_WORKING . 'language/en_us/classes/subaccount_is.php');
}
