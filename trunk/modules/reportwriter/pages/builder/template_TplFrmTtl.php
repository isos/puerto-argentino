...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/pages/builder/template_TplFrmTtl.php
//

  $kFontColors = gen_build_pull_down($FontColors);
  echo html_form('FrmTotal', FILENAME_DEFAULT, gen_get_all_get_params(array('action')) . 'action=step6a');
...
<h2 align="center"><?php echo TEXT_FORM_FIELD . $DisplayName . ' - ' . TEXT_PROPERTIES; ?></h2>
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <th colspan="2"><?php echo TEXT_FIELDS; ?></th>
    </tr>
    <tr>
      <td colspan="2" align="center"><?php echo RW_RPT_FLDTOTAL; ?></td>
    </tr>
    <tr>
      <td><?php echo html_combo_box('TotalField', CreateSpecialDropDown($ReportID), $Params['TotalField']); ?></td>
      <td><?php echo html_icon('actions/list-add.png', TEXT_ADD, 'medium', 'onclick="submitToDo(\'add_total\')"'); ?></td>
    </tr>
    <tr>
      <td><?php echo html_pull_down_menu('FieldIndex', gen_build_pull_down($Params['Seq']), '', 'size="3"'); ?></td>
      <td valign="bottom"><?php echo html_icon('emblems/emblem-unreadable.png', TEXT_REMOVE, 'medium', 'onclick="submitToDo(\'remove\')"'); ?></td>
    </tr>
    <tr>
