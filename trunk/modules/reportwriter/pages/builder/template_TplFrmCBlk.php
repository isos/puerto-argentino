...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/pages/builder/template_TplFrmCBlk.php
//

  $kFontColors = gen_build_pull_down($FontColors);
  echo html_form('FrmCoBlock', FILENAME_DEFAULT, gen_get_all_get_params(array('action')) . 'action=step6a');
...
<h2 align="center"><?php echo TEXT_FORM_FIELD . $DisplayName . ' - ' . TEXT_PROPERTIES; ?></h2>
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    ...
    <tr>
      ...
      <td><?php echo html_pull_down_menu('TblField', CreateCompanyArray(), $Params['TblField']); ?></td>
