...
<h2 align="center"><?php echo TEXT_FORM_FIELD . $DisplayName . ' - ' . TEXT_PROPERTIES; ?></h2>
  <table align="center" border="2" cellspacing="1" cellpadding="1">
    ...
    <tr>
	  <th colspan="2" align="center"><?php echo RW_RPT_IMAGEDIM; ?></th>
	</tr>
	<tr>
      <td align="center">
    ...
    <tr>
      ...
      <td><?php echo html_pull_down_menu('BarCodeType', gen_build_pull_down($BarCodeTypes), $Params['BarCodeType']); ?></td>
    </tr>
	<tr>
	...
	<tr>
      <td><?php echo RW_RPT_BRDRLINE; ?></td>
      <td>
	    <?php echo html_radio_field('Line', '0', (!$Params['Line']) ? true : false) . TEXT_NO; ?>
	    <?php echo html_radio_field('Line', '1',  ($Params['Line']) ? true : false) . TEXT_YES; ?>
	  </td>
    </tr>
    <tr>
