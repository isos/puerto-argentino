...
// +-----------------------------------------------------------------+
//  Path: /modules/reportwriter/language/es_cr/classes/day_book.php
//
...
define('RW_AR_BEG_BAL','Saldo Inicial');
define('RW_AR_DEPOSITS','Depósitos');
define('RW_AR_WITHDRAWAL','Retiros');
