...
// +-----------------------------------------------------------------+
//  Path: /modules/banking/pages/bills_deposit/template_main.php
//
...
// Build the page
?>
<div class="pageHeading"><?php echo constant('BNK_DEP_' . JOURNAL_ID . '_' . strtoupper($type) . '_WINDOW_TITLE'); ?></div>
<div>
...
<?php echo html_pull_down_menu('shipper_code', $payment_choices, $order->shipper_code, 'onchange="activateFields()"') . chr(10);
	$count = 0;
...
<div>
  <table id="item_table" align="center" border="1" cellpadding="1" cellspacing="1">
	<tr>
