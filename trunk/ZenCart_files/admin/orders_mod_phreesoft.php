...
<?php // Download icon added by PhreeSoft to download order
                   if ($orders->fields['phreebooks'] == 0 && MODULE_PHREEBOOKS_ORDER_DOWNLOAD_STATUS == 'True') {
                     echo '<a href="' . zen_href_link(FILENAME_ORDERS, zen_get_all_get_params(array('oID', 'action')) . 'oID=' . $orders->fields['orders_id'] . '&action=download', 'NONSSL') . '">' . zen_image(DIR_WS_IMAGES . 'icons/file_download.gif', ICON_FILE_DOWNLOAD) . '</a>';
                   }
// End added by PhreeSoft ?>
