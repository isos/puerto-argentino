...
// +-----------------------------------------------------------------+
//  Path: /modules/assets/pages/cat_assets/js_include.php
//
...
plusSign.src = "<?php echo DIR_WS_THEMES; ?>icons/16x16/actions/list-add.png";
var minusSign = new Image(16,16);
minusSign.src= " <?php echo DIR_WS_THEMES; ?>icons/16x16/actions/list-remove.png";
...
function del_index(boxId, index) {
	if (confirm('Do you really want to delete this index')) {
		var formId = boxId + '_frm';
