...
?>
  <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
	...
	<td class="dataTableContent"><?php echo $category_array[$query_result->fields['category_id']]; ?></td>
	<td class="dataTableContent"><?php echo $query_result->fields['entry_type']; ?></td>
...
// build the action toolbar
	  ...
	  if ($security_level > 3) echo html_icon('emblems/emblem-unreadable.png', TEXT_DELETE, 'small', 'onclick="if (confirm(\'' . ASSETS_DELETE_INTRO_FIELDS . '\')) submitSeq(' . $query_result->fields['id'] . ', \'delete\')"') . chr(10);
?>
	</td>
  </tr>
<?php
