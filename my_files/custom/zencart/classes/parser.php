...
// +-----------------------------------------------------------------+
//  Path: /my_files/custom/zencart/classes/parser.php
//
...
class parser {
	...
	function parse($strInputXML) {
		...
		if(!$this->strXmlData) {
		    $strText = 'PhreeBooks Zencart XML parse error: ' . xml_error_string(xml_get_error_code($this->resParser)) . ' at line ' . xml_get_current_line_number($this->resParser);
