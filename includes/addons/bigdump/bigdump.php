...
// file: /includes/addons/bigdump/bigdump.php
$db_server   = DB_SERVER;
$db_name     = DB_DATABASE;
...
<?php // ****************************** BOF - Mods by PhreeSoft **************************************** ?>
  ...
  include_once(DIR_FS_ADMIN . 'includes/addons/bigdump/language/' . $_SESSION['language'] . '/language.php');
...
$web_dir    = DIR_WS_FULL_PATH . 'my_files/backups';
// ****************************** EOF - Mods by PhreeSoft ****************************************
