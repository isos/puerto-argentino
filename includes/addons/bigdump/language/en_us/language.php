...
define('BIGDUMP_IMPORT_MSG_1','UNEXPECTED: Non-numeric values for start and foffset');
...
define('BIGDUMP_READ_SUCCESS','Congratulations: End of file reached, assuming OK');
?>