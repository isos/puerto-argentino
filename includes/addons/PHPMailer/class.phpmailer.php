...
// ******************** BOF - Modified by PhreeBooks ********************
	if (file_exists(DIR_FS_ADDONS . 'PHPMailer/language/' . $_SESSION['language'] . '/language.php')) {
	  require(DIR_FS_ADDONS . 'PHPMailer/language/' . $_SESSION['language'] . '/language.php');
	} else {
	  require(DIR_FS_ADDONS . 'PHPMailer/language/en_us/language.php');
	}
