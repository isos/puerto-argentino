...
// +-----------------------------------------------------------------+
//  Path: /includes/javascript/menu.js
//
...
function elementContains(elmOuter, elmInner) {
  while (elmInner && elmInner != elmOuter) {
    try { elmInner = elmInner.parentNode; } catch(e) { return false; }
  }
...
function cssjsmenu(menuid) {
  ...
  // check for downlevel browsers, Opera 6, IE 5/Mac are not supported
  var version;
  var offset;
...
//		parent.onmouseover = function (e) {
		parent.onclick = function (e) {
		  if (menu_opened) return; // select the menu item
		  var i;
          var child;
          var point;
